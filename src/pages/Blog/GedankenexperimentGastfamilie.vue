<template>
  <Layout>
    <Section class="section">
      ...
      <h1 class="blog__title">Ignorieren, Schimpfen, Strafen, Erpressen... Warum herkömmliche Erziehungsmethoden unseren Kindern schaden</h1>
      <p>
      ...
      <br />
      <p>
        Viele Eltern sind im Verlauf ihres Lebens mit solchen oder ähnlichen Erziehungstipps in Kontakt gekommen. In diesem Beitrag zeige ich auf, warum herkömmliche Erziehungsmethoden wie Ignorieren, Schimpfen, Strafen oder Belohnen (bzw. Erpressen) unseren Kindern schaden. Es fällt nicht allen leicht, so tief in der Gesellschaft verwurzelte Überzeugungen zu hinterfragen und loszulassen. Das folgende Gedankenexperiment kann dabei helfen:
      <br /><br />
      ...
      <p>
        <strong>Frag dich einmal: Wenn du frei auswählen könntest, was für eine Gastfamilie würdest du dir dann aussuchen? Wie würde sie sich von der Gastfamilie im Gedankenexperiment unterscheiden?</strong>
      </p>
          <g-image
...
export default {
  ...
  metaInfo: {
    ...
    title: "Ignorieren, Schimpfen, Strafen, Erpressen... Warum herkömmliche Erziehungsmethoden unseren Kindern schaden",
  },
  mounted() {
